...
Route::get('/doseador/{doseador}/darAgua/{animal}', 'AnimaisController@darAgua')->name('darAgua');
Route::get('/doseador/{doseador}/darComida/{animal}', 'AnimaisController@darComida')->name('darComida');
...
Route::post('/infoSistema', 'AnimaisController@infoSistema')->name('infoSistema');